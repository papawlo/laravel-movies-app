    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        ...
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap items-center text-indigo-300 text-sm">
                <svg viewBox="0 0 24 24" class="fill-current text-yellow-500 w-4">
                    <g data-name="Layer 2">
                        <path
            ...
            <div class="mt-12">
                ...
                <div class="flex mt-4">
                    ...
                    <div class="mr-8">
                        <div>{{ $crew['name'] }}</div>
                        <div class="text-sm text-indigo-400">{{ $crew['job'] }}</div>
                    </div>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="{{ route('actors.show', $cast['id']) }}"
                        class="text-lg mt-2 hover:text-indigo:300">{{ $cast['name'] }}</a>
